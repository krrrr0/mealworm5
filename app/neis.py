...
class NEIS:
    ...
    def search_school(self, query):
        ...
        response = requests.request('GET', url, data='', headers={}, params=querystring, timeout=5)
        data = response.json()
    ...
    class School:
        ...
        def get_meal(self, date, time):
            ...
            response = requests.request('GET', url, data=payload, headers=headers, params=querystring, timeout=5)
            data = response.json()
